##### STEPS #####
1. Run MasterConsole and follow further instructions on the input GUI.
...
Transport.py -> searching algorithm, backend operations for transport

##### LEGEND: FOLDERS #####
assets -> contains image files
fonts -> contains font files
presentation -> files we used for our presentation
